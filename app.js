  ...
  if (btnTTS && 'speechSynthesis' in window) {
    btnTTS.addEventListener('click', () => {
      if (isSpeaking) {
        ...
        const textToRead = "Welcome to Government Special Education Centre, Jalalpur Pirwala. A public sector institution offering 100 percent free specialized education, therapy, psychological assessments, and free student transport under the Special Education Department, Government of Punjab. Head of Institution: Ms. Fozia Hamid, Headmistress and Drawing and Disbursing Officer. Primary specialization wings include Hearing Impaired, Physically Disabled, Visually Impaired, and Slow Learners.";
